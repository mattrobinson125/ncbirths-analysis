...
MomRace        | Mother's race: 1=white, 2=black, 3=American Indian, 4=Chinese, 5=Japanese, 6=Hawaiian, 7=Filipino, 8=Other Asian or Pacific Islander
...
ggplot(NCbirths1, aes(MomAge, Gained, color=factor(Marital))) + geom_point() + geom_smooth(method="lm")
```
