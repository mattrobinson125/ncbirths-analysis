...
<<<<<<< HEAD
  html_document:
    toc: yes
=======
>>>>>>> 6bcd80bfb9ffa3915bcd68790e3a38137cb030bd
=======
  html_document:
    toc: yes
>>>>>>> 1c756070b2d62380feb4151dd26c42814afc7fbc
  pdf_document:
    toc: yes
---
...
##Regression Model
````{r, echo = false}
MultipleBirths = lm(BirthWeightOz ~ Plural + Marital, data=NCbirths1)
summary(MultipleBirths)
```
