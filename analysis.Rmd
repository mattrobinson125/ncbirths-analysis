...
ggplot(NCbirths, aes(MomAge, Weeks, color=factor(MomRace))) + geom_point(size=.5) + labs(color="Race")

qplot(Gained, data = NCbirths, geom = "density", color = factor(Marital)) + ylab("") + labs(color="Marital")
```
