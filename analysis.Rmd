...
=======
1. Births involving a single mother will exhibit a higher weight gained during pregnancy, a lower average of weeks of gestation and a lower average child weight at birth.
...
<<<<<<< HEAD
NCbirths[!complete.cases(NCbirths),]
NCbirths2<-na.omit(NCbirths)
=======
```{r}
